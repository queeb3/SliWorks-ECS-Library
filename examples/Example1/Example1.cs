...
class Program
{
    public static Nexus Nex;
    public static EntityRegister ER;
    public static ComponentRegister CR;
    ...
    static void Main()
    {
        ...
        Nex.BindComponentRegister(CR);
        Nex.BindArchetypeRegister();
        Nex.BindQueryManager();
...
//     public Query Query { get; } = new Query().With<Health>();
